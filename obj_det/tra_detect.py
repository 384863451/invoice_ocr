...
converter = {'invoice_number': 'invoice_number', 'totalAmount': 'amountTax', 'ids': 'ids', 'date': 'billingDate', 'checi': 'checi',
             'start': 'starStation', 'end': 'endStation'}
pub_weights = "models/huochepiao/best.pt"
pub_view_img = False
pub_save_txt = False
pub_img_size = 640
pub_nosave = False
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        i = i + 1
                        if "checi" == label or "invoice_number" == label:
